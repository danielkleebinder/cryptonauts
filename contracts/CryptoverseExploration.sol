...
contract CryptoverseExploration is CryptoversePlanets, CryptoverseAstronauts, CryptoverseItems {
    ...
    modifier onlyOnPlanet() {
        require(explorations[msg.sender].exploring, "Must be on the planet");
        _;
    }
    ...
    function explorePlanet(uint _planetId) external {
        require(isPlanet(_planetId), "Not a planet");
        ...
        require(!exploration.exploring, "Already exploring");
        require(travelTime >= requiredTravelTime, "Still occupied");
